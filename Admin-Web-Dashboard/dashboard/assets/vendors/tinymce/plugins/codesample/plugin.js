    ...
    (function (define, exports, module, require) {
      ...
      (function (f) {
        ...
        return function () {
          ...
          14: [
            function (require, module, exports) {
              var Prism = require('prismassets/js/components/prism-core');
              require('prismassets/js/components/prism-clike');
              require('prismassets/js/components/prism-markup-templating');
              require('prismassets/js/components/prism-c');
              require('prismassets/js/components/prism-cpp');
              require('prismassets/js/components/prism-csharp');
              require('prismassets/js/components/prism-css');
              require('prismassets/js/components/prism-java');
              require('prismassets/js/components/prism-javascript');
              require('prismassets/js/components/prism-markup');
              require('prismassets/js/components/prism-php');
              require('prismassets/js/components/prism-python');
              require('prismassets/js/components/prism-ruby');
              module.exports = { boltExport: Prism };
            },
            {
              'prismassets/js/components/prism-c': 1,
              'prismassets/js/components/prism-clike': 2,
              'prismassets/js/components/prism-core': 3,
              'prismassets/js/components/prism-cpp': 4,
              'prismassets/js/components/prism-csharp': 5,
              'prismassets/js/components/prism-css': 6,
              'prismassets/js/components/prism-java': 7,
              'prismassets/js/components/prism-javascript': 8,
              'prismassets/js/components/prism-markup': 10,
              'prismassets/js/components/prism-markup-templating': 9,
              'prismassets/js/components/prism-php': 11,
              'prismassets/js/components/prism-python': 12,
              'prismassets/js/components/prism-ruby': 13
            }
          ]
        }, {}, [14])(14);
      }));

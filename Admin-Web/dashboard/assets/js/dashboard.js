(function($) {
  ...
  $(function() {
    ...
    if ($("#north-america-chart-dark").length) {
      ...
      var graphAccuracyNoCanvas = $("#north-america-chart-dark").get(0).getContext("2d");
      ...
      document.getElementById('north-america-legend').innerHTML = graphAccuracyNo.generateLegend();
    }
